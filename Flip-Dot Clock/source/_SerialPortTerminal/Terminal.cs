  ...
  public partial class frmTerminal : Form
  {
    ...
    { e.Handled = KeyHandled; }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            groupBox2.Text = DateTime.Now.ToString("yyyy-MM-dd  HH:mm:ss");
     
        }

        private void button1_Click(object sender, EventArgs e)
        {
            //ieinam i laiko nustatyma
            comport.Write("t");
            Log(LogMsgType.Outgoing, "t" + "\n");

            Thread.Sleep(100);
            
            //valandos
            comport.Write(DateTime.Now.ToString("HH") + " ");
       //     Log(LogMsgType.Outgoing, DateTime.Now.ToString("HH")  + "\n");

            Thread.Sleep(100);

            //minutes
            comport.Write(DateTime.Now.ToString("mm") + " ");
       //     Log(LogMsgType.Outgoing, DateTime.Now.ToString("mm") + "\n");

            Thread.Sleep(100);

            //sekundes
            comport.Write(DateTime.Now.ToString("ss") + " ");
        //    Log(LogMsgType.Outgoing, DateTime.Now.ToString("ss") + "\n");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //ieinam i datos nustatyma
           comport.Write("d");
           Log(LogMsgType.Outgoing, "d" + "\n");

            Thread.Sleep(100);

            //metai
            comport.Write(DateTime.Now.ToString("yy") + " ");
            //     Log(LogMsgType.Outgoing, DateTime.Now.ToString("HH")  + "\n");
            ...
            //diena
            comport.Write(DateTime.Now.ToString("dd") + " ");
            //    Log(LogMsgType.Outgoing, DateTime.Now.ToString("ss") + "\n");
